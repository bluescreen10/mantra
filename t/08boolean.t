...
true ifFalse: { System out: 'not ok 3 true ifFalse method'}.

"false"
false ifTrue:  { System out: 'not ok 4 false ifTrue  method'}.
false ifFalse: { System out: 'ok  4 false ifFalse method'}.

"not method"
true not ifFalse: { System out: 'ok 5 true not method' }
         ifTrue:  { System out: 'not ok 5 true not method' }. 

"not method"
false not ifTrue:  { System out: 'ok  6 false not method' }
          ifFalse: { System out: 'not ok 6 false not method' }. 